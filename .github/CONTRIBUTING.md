# Contributing
By participating to this project, you agree to abide our [code of conduct](https://github.com/librepod/frp-operator/blob/main/.github/CODE_OF_CONDUCT.md).
...
Fork and clone **[frp-operator](https://github.com/librepod/frp-operator)** repository.
...
Please also update the [CHANGELOG.md](https://github.com/librepod/frp-operator/blob/main/CHANGELOG.md) to note what you've added or fixed.
